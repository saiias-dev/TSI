    ...
    return (
      <Container>
        <Helmet>
          ...
          <meta name="keywords" content="Основной контент"></meta>
        </Helmet>
        <div className="flex gap-4">
          <Text
            color="primary"
            size="large"
            title="Диза́йн (от англ. design — рисовать, чертить, задумывать, а также проект, план, рисунок) — деятельность по проектированию эстетических свойств промышленных изделий («художественное конструирование»[1]), а также результат этой деятельности (например, в таких словосочетаниях, как «дизайн автомобиля»)[2].
